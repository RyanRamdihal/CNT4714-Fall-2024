...
public class SQLClient extends JFrame {
    ...
    public SQLClient() {
        super("SQL Client APP - FALL 2024");
        ...
        JComboBox<String> URLitems = new JComboBox<>(new String[] { "project3.properties", "bikedb.properties" });
        formPanel.add(URL);
        formPanel.add(URLitems);

        // Row 2: User Properties
        JLabel userProperties = new JLabel("User Properties");
        JComboBox<String> userItems = new JComboBox<>(new String[] { "root.properties", "client1.properties", "client2.properties" });
    ...
    public static void main(String[] args) {
        new SQLClient();  // Create and display the application
